...
# awe_system_ui/
APPS_DIR = BASE_DIR / "awe_system_ui"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "awe_system_ui.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "awe_system_ui.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""John M. Gayed""", "gayed@waseda.jp")]
...
CELERY_TASK_TIME_LIMIT = 40 * 60  # 40 minutes
...
REST_AUTH = {
    ...
    "REGISTER_SERIALIZER": "awe_system_ui.users.api.serializers.CustomRegisterSerializer",
    "TOKEN_SERIALIZER": "awe_system_ui.users.api.serializers.TokenSerializer",
    "USER_DETAILS_SERIALIZER": "awe_system_ui.users.api.serializers.CustomUserDetailsSerializer",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "AiAWE API",
    "DESCRIPTION": "Documentation of API endpoints of AiAWE",
    "VERSION": "1.0.0",
