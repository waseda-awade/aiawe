<template>
  <div class="container mx-auto px-4 md:py-8 max-w-4xl">
    ...
    <div class="space-y-6 text-lg">
      ...
      <section>
        <h2 class="text-2xl font-semibold mb-3">Research Team</h2>
        <div class="space-y-4">
          <div>
      ...
      <section>
        ...
        <p>
          ...
          <br><br>Wang, Q., & Gayed, J. M. (2024). Effectiveness of large language models in automated evaluation of argumentative essays: finetuning vs. zero-shot prompting. Computer Assisted Language Learning, 1–29. 
      ...
      <section>
        ...
        <ul class="list-disc list-inside mt-2 space-y-2">
          <li>If you would like to cite AiAWE in your research, please use the following citation: Gayed, J. M. (March, 2025). AiAWE (Version 1.0) [Web application]. https://app.awade.gec.waseda.ac.jp </li>
